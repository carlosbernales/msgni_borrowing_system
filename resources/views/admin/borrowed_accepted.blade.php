                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
							...
							<table id="example1" class="table table-bordered table-striped">
									...
									<tbody>
										@foreach ($borrowed_accepted as $borrowed)
											<tr>
												...
												<td>{{ \Carbon\Carbon::parse($borrowed->deadline)->format('F d, Y') }}</td>
                                                <td>
                                                    <form action="/borrow_completed/{{ $borrowed->id }}" method="POST" class="d-inline">
														@csrf
														@method('PUT')
